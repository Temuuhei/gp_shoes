...
class stock_inventory_statement(osv.osv_memory):
    ...
    def get_export_data(self, cr, uid, ids, report_code, context=None):
        ...
        if wiz['income_expense']:
            ...
            if wiz['cost']:
                if len(warehouses) > 1:
                    headers[0] += [u'НИЙТ',None,None,None,None,None,None,None,None,None,None,None]
                    headers[1] += [u'Эхний үлдэгдэл',None,None,u'Орлого',None,None,u'Зарлага',None,None,u'Эцсийн үлдэгдэл',None,None]
                    headers[2] += [u'Тоо хэмжээ', u'Зарах үнийн дүн', u'Өртөгийн дүн', u'Тоо хэмжээ', u'Зарах үнийн дүн',u'Өртөгийн дүн',
                                   u'Тоо хэмжээ', u'Зарах үнийн дүн', u'Өртөгийн дүн', u'Тоо хэмжээ', u'Зарах үнийн дүн',u'Өртөгийн дүн']
                    header_span += [((colx, 0),(colx+11, 0)), ((colx,1), (colx+2,1)),
                                    ((colx+3, 1),(colx+5, 1)), ((colx+6, 1),(colx+8, 1)),((colx+9,1),(colx+11,1))]
                    colx += 12
                    widths += [3,3,3,3,3,3,3,3,3,3,3,3,3]
                for wh in warehouses:
                    headers[0] += [wh.name,None,None,None,None,None,None,None,None,None,None,None,None]
                    headers[1] += [u'Худалдах үнэ',u'Эхний үлдэгдэл',None,None,u'Орлого',None,None,u'Зарлага',None,None,u'Эцсийн үлдэгдэл',None,None]
                    headers[2] += [None,u'Тоо хэмжээ', u'Зарах үнийн дүн', u'Өртөгийн дүн', u'Тоо хэмжээ', u'Зарах үнийн дүн',u'Өртөгийн дүн',
                                   u'Тоо хэмжээ', u'Зарах үнийн дүн', u'Өртөгийн дүн', u'Тоо хэмжээ', u'Зарах үнийн дүн',u'Өртөгийн дүн']
                    header_span += [((colx, 0),(colx+12, 0)), ((colx,1), (colx,2)),((colx+1,1), (colx+3,1)),
                                    ((colx+4, 1),(colx+6, 1)), ((colx+7, 1),(colx+9, 1)),((colx+10,1),(colx+12,1))]
                    colx += 13
                    widths += [3,3,3,3,3,3,3,3,3,3,3,3,3,3]
            else:
                if len(warehouses) > 1:
                    headers[0] += [u'НИЙТ',None,None,None,None,None,None,None]
                    headers[1] += [u'Эхний үлдэгдэл',None,u'Орлого',None,u'Зарлага',None,u'Эцсийн үлдэгдэл',None]
                    headers[2] += [u'Тоо хэмжээ', u'Зарах үнийн дүн',u'Тоо хэмжээ', u'Зарах үнийн дүн',
                                   u'Тоо хэмжээ', u'Зарах үнийн дүн',u'Тоо хэмжээ', u'Зарах үнийн дүн']
                    header_span += [((colx,0),(colx+7,0)),((colx,1),(colx+1,1)),((colx+2,1),(colx+3,1)),((colx+4,1),(colx+5,1)),
                                    ((colx+6,1),(colx+7,1))]
                    colx += 8
                    widths += [4,4,4,4,4,4,4,4]
                for wh in warehouses:
                    headers[0] += [wh.name,None,None,None,None,None,None,None,None]
                    headers[1] += [u'Худалдах үнэ',u'Эхний үлдэгдэл',None,u'Орлого',None,u'Зарлага',None,u'Эцсийн үлдэгдэл',None]
                    headers[2] += [None,u'Тоо хэмжээ', u'Зарах үнийн дүн',u'Тоо хэмжээ', u'Зарах үнийн дүн',
                                   u'Тоо хэмжээ', u'Зарах үнийн дүн',u'Тоо хэмжээ', u'Зарах үнийн дүн']
                    header_span += [((colx,0),(colx+8,0)),((colx,1),(colx,2)),((colx+1,1),(colx+2,1)),((colx+3,1),(colx+4,1)),
                                    ((colx+5,1),(colx+6,1)),((colx+7,1),(colx+8,1))]
                    colx += 9
    ...
    def prepare_report_data(self, cr, uid, wiz, context=None):
        ...
        if wiz['income_expense']:
            ...
            initial_end_date_where = " and m.date < '%s' " % (wiz['date_to'] + ' 23:59:59')
            initial_datetime_where = " and his.datetime <= '%s' " % (wiz['date_from'] + ' 00:00:00')
            initial_end_datetime_where = " and his.datetime <= '%s' " % (wiz['date_to'] + ' 23:59:59')
            total_dict = {'start_qty': 0,
                          'start_cost': 0,
                          'last_cost': 0,
                          'last_cost_total': 0,
                          'start_cost_total': 0,'start_price': 0, 'start': 0,
            ...
            if wiz['prod_categ_ids']:
                categ_ids = self.pool.get('product.category').search(cr, uid, [('parent_id','child_of',wiz['prod_categ_ids'])], context=context)
            ...
            for wh in warehouses:
                ...
                if wh.id not in total_dict['whs']:
                    total_dict['whs'][wh.id] = {'start_qty': 0,'last_cost': 0,'start_cost': 0,'start_cost_total': 0,'last_cost_total': 0,'start_price': 0, 'start': 0,
                                                'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                    if wh.id == 1:
                    # Тайлант хугацааны эхний үлдэгдэл
                        cr.execute("""SELECT myquery.product_id as prod, """+parent_select+"""
                                        sum(myquery.q) as q, sum(myquery.tc) as tc, sum(myquery.price) as l,
                                        (SELECT  cost
                                        FROM product_price_history his  
                                        JOIN product_template pt ON (pt.id=his.product_template_id) 
                                        JOIN product_product pp ON (pp.product_tmpl_id=pt.id) 
                                            WHERE  pp.id=myquery.product_id 
                                                    """+ initial_datetime_where +""" and cost is not Null and cost != 0  order by his.datetime desc limit 1 )  as c
                                   FROM ( 
                                            (SELECT m.product_id,  """+select+"""
                                                    coalesce(sum(m.product_qty/u.factor*u2.factor),0) as q, 
                                                    coalesce(sum(m.price_unit*m.product_qty),0) as tc, 
                                           ...
                                           (SELECT m.product_id, """+select+"""
                                               ...
                                               WHERE m.state = 'done' """+where+"""
                                                ...
                                                having sum(myquery.q)::decimal(16,4) <> 0 order by myquery.product_id""", (locations, locations, locations, locations))
                    else:
                                        # Тайлант хугацааны эхний үлдэгдэл
                        cr.execute("SELECT myquery.product_id AS prod, "+parent_select+""
                ...
                if fetched:
                    for f in fetched:
                        price = 0
                        if f['prod']:
                            price = product_obj.price_get(cr, uid, f['prod'], 'list_price', context=ctx)[f['prod']]
                        ...
                        if wiz['grouping']:
                            if f['group_id'] not in data_dict:
                                data_dict[f['group_id']] = {'name': f['gname'] or u'Тодорхойгүй',
                                                            ...
                                                            'last_cost': 0,
                                                            'start_qty': 0,'start_cost': 0,'start_cost_total': 0,'last_cost_total': 0,'start_price': 0, 'start': 0,
                                                            'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                            'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                            'end_qty': 0, 'end_cost': 0, 'end_price': 0,
                                                            'lines': {}, 'whs':{}}
                            if wh.id not in data_dict[f['group_id']]['whs']:
                                data_dict[f['group_id']]['whs'][wh.id] = {'start_qty': 0,
                                                            'last_cost': 0,'start_cost': 0,'start_cost_total': 0,'last_cost_total': 0,'start_price': 0, 'start': 0,
                                                                          'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                          'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                          'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                            if f['prod'] not in data_dict[f['group_id']]['lines']:
                                data_dict[f['group_id']]['lines'][f['prod']] = {'start_qty': 0,
                                                            'last_cost': 0,'start_cost': 0,'start_cost_total': 0,'last_cost_total': 0,'start_price': 0, 'start': 0,
                                                                                'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                                'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                                'end_qty': 0, 'end_cost': 0, 'end_price': 0,'whs': {}}
                            if wh.id not in data_dict[f['group_id']]['lines'][f['prod']]['whs']:
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id] = {'start_qty': 0,
                                                            'last_cost': 0,'start_cost': 0,'start_cost_total': 0,'last_cost_total': 0,'start_price': 0, 'start': 0,
                                                                                              'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                                              'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                                              'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                            if wh.id == 1:
                                ...
                                data_dict[f['group_id']]['start_cost_total'] += f['tc']
                                ...
                                data_dict[f['group_id']]['whs'][wh.id]['start_cost_total'] += f['tc']
                                ...
                                data_dict[f['group_id']]['lines'][f['prod']]['start_cost_total'] += f['tc']
                                ...
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['start_cost_total'] += f['tc']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['start_price'] += f['l']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['start'] += f['q'] * price                                
                            else: 
                                data_dict[f['group_id']]['start_qty'] += f['q']
                                data_dict[f['group_id']]['start_cost'] += f['c']
                                data_dict[f['group_id']]['start_cost_total'] += f['c']
                                data_dict[f['group_id']]['start_price'] += f['l']
                                data_dict[f['group_id']]['start'] += f['q'] * price
                                data_dict[f['group_id']]['whs'][wh.id]['start_qty'] += f['q']
                                data_dict[f['group_id']]['whs'][wh.id]['start_cost'] += f['c']
                                data_dict[f['group_id']]['whs'][wh.id]['start_cost_total'] += f['c']
                                data_dict[f['group_id']]['whs'][wh.id]['start_price'] += f['l']
                                data_dict[f['group_id']]['whs'][wh.id]['start'] += f['q'] * price
                                data_dict[f['group_id']]['lines'][f['prod']]['start_qty'] += f['q']
                                data_dict[f['group_id']]['lines'][f['prod']]['start_cost'] += f['c']
                                data_dict[f['group_id']]['lines'][f['prod']]['start_cost_total'] += f['c']
                                data_dict[f['group_id']]['lines'][f['prod']]['start_price'] += f['l']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['start_qty'] += f['q']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['start_cost'] += f['c']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['start_cost_total'] += f['c']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['start_price'] += f['l']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['start'] += f['q'] * price
                        else:
                            if f['prod'] not in data_dict:
                                data_dict[f['prod']] = {'start_qty': 0,
                                                        'start_cost': 0,'last_cost':0,'start_cost_total': 0,'last_cost_total':0,'start_price': 0, 'start': 0,
                                                        'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                        'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                        'end_qty': 0, 'end_cost': 0, 'end_price': 0,'whs': {}}
                            if wh.id not in data_dict[f['prod']]['whs']:
                                data_dict[f['prod']]['whs'][wh.id] = {'start_qty': 0,
                                                                      'start_cost': 0,'last_cost':0,'start_cost_total': 0,'last_cost_total':0,'start_price': 0, 'start': 0,
                                                                      'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                      'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                      'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                            if wh.id == 1:    
                                ...
                                data_dict[f['prod']]['start_cost_total'] += f['c'] * f['q']#f['tc']
                                ...
                                data_dict[f['prod']]['whs'][wh.id]['start_cost_total'] += f['c'] * f['q']#f['tc']
                                data_dict[f['prod']]['whs'][wh.id]['start_price'] += f['l']
                                data_dict[f['prod']]['whs'][wh.id]['start'] += f['q'] * price
                            else:
                                data_dict[f['prod']]['start_qty'] += f['q']
                                data_dict[f['prod']]['start_cost'] += f['c']
                                data_dict[f['prod']]['start_cost_total'] += f['c']
                                data_dict[f['prod']]['start_price'] += f['l']
                                data_dict[f['prod']]['start'] += f['q'] * price
                                data_dict[f['prod']]['whs'][wh.id]['start_qty'] += f['q']
                                data_dict[f['prod']]['whs'][wh.id]['start_cost'] += f['c']
                                data_dict[f['prod']]['whs'][wh.id]['start_cost_total'] += f['c']
                                data_dict[f['prod']]['whs'][wh.id]['start_price'] += f['l']
                                data_dict[f['prod']]['whs'][wh.id]['start'] += f['q'] * price
                        if wh.id == 1:  
                            total_dict['start_qty'] += f['q']
                            total_dict['start_cost'] = f['c']
                            total_dict['start_cost_total'] += f['c'] * f['q']#f['tc']
                            ...
                            total_dict['whs'][wh.id]['start_cost_total'] += f['c'] * f['q']#f['tc']
                            total_dict['whs'][wh.id]['start_price'] += f['l']
                            total_dict['whs'][wh.id]['start'] += f['q'] * price
                        else:
                            total_dict['start_qty'] += f['q']
                            total_dict['start_cost'] += f['c']
                            total_dict['start_cost_total'] += f['c']
                            total_dict['start_price'] += f['l']
                            total_dict['start'] += f['q'] * price
                            total_dict['whs'][wh.id]['start_qty'] += f['q']
                            total_dict['whs'][wh.id]['start_cost'] += f['c']
                            total_dict['whs'][wh.id]['start_cost_total'] += f['c']
                            total_dict['whs'][wh.id]['start_price'] += f['l']
                            total_dict['whs'][wh.id]['start'] += f['q'] * price
                 
                if wh.id ==1:        
                # Тайлант хугацааны эцсийн өртөг үлдэгдэл
                    ...
                    cr.execute("""SELECT myquery.product_id as prod, """+parent_select+"""
                                        ...
                                        JOIN product_product pp ON (pp.product_tmpl_id=pt.id) 
                                            WHERE  pp.id=myquery.product_id 
                                                    """+ initial_end_datetime_where +""" and cost is not null and cost != 0  order by his.datetime desc limit 1 )  as lc
                                   FROM ( 
                                            (SELECT m.product_id,  """+select+"""
                                                    coalesce(sum(m.product_qty/u.factor*u2.factor),0) as q, 
                                                    coalesce(sum(m.price_unit*m.product_qty),0) as tc, 
                    ...
                    if fetched:
                        for f in fetched:
                            ...
                            if wiz['grouping']:
                                ...
                                if wh.id not in data_dict[f['group_id']]['lines'][f['prod']]['whs']:
                                    data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id] = {'start_qty': 0,
                                                                'last_cost': 0,'start_cost': 0,'start_cost_total': 0,'start_price': 0,'last_cost_total': 0, 'start': 0,
                                                                                                  'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                                                  'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                                                  'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                                data_dict[f['group_id']]['last_cost'] = f['lc']
                                data_dict[f['group_id']]['last_cost_total'] += f['lc'] * f['q']
                                data_dict[f['group_id']]['whs'][wh.id]['last_cost'] = f['lc']
                                data_dict[f['group_id']]['whs'][wh.id]['last_cost_total'] += f['lc'] * f['q']
                                data_dict[f['group_id']]['lines'][f['prod']]['last_cost'] = f['lc']
                                data_dict[f['group_id']]['lines'][f['prod']]['last_cost_total'] += f['lc'] * f['q']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['last_cost'] = f['lc']
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['last_cost_total'] += f['lc'] * f['q']
                            else:
                                if f['prod'] not in data_dict:
                                    data_dict[f['prod']] = {'start_qty': 0,'start_cost': 0,'last_cost': 0,'start_cost_total': 0,'last_cost_total': 0,'start_price': 0, 'start': 0,
                                                            'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                            'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                            'end_qty': 0, 'end_cost': 0, 'end_price': 0,'whs': {}}
                                if wh.id not in data_dict[f['prod']]['whs']:
                                    data_dict[f['prod']]['whs'][wh.id] = {'start_qty': 0,'start_cost': 0,'last_cost': 0,'start_cost_total': 0,'last_cost_total': 0,'start_price': 0, 'start': 0,
                                                                          'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                          'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                          'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                                
                                data_dict[f['prod']]['last_cost'] = f['lc']
                                data_dict[f['prod']]['last_cost_total'] += f['lc'] * f['q']#f['tc']
                                data_dict[f['prod']]['whs'][wh.id]['last_cost'] = f['lc']
                                data_dict[f['prod']]['whs'][wh.id]['last_cost_total'] += f['lc'] * f['q']#f['tc']
                            total_dict['last_cost'] = f['lc']
                            total_dict['last_cost_total'] += f['lc'] * f['q']#f['tc']
                            total_dict['whs'][wh.id]['last_cost'] = f['lc']
                            total_dict['whs'][wh.id]['last_cost_total'] += f['lc'] * f['q']#f['tc']
                ...
                for f in fetched:
                    ...
                    if wiz['grouping']:
                        if f['group_id'] not in data_dict:
                            data_dict[f['group_id']] = {'name': f['gname'] or u'Тодорхойгүй',
                                                        'group_id': f['group_id'] or None,
                                                        'start_qty': 0, 'start_cost': 0, 'last_cost': 0,'start_price': 0, 'start': 0,
                                                        'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                        'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                        'end_qty': 0, 'end_cost': 0, 'end_price': 0,
                                                        'whs': {}, 'lines':{}}
                        if wh.id not in data_dict[f['group_id']]['whs']:
                            data_dict[f['group_id']]['whs'][wh.id] = {'start_qty': 0, 'start_cost': 0, 'last_cost': 0,'start_price': 0, 'start': 0,
                                                                      'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                      'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                      'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                        if f['prod'] not in data_dict[f['group_id']]['lines']:
                            data_dict[f['group_id']]['lines'][f['prod']] = {'start_qty': 0, 'start_cost': 0, 'last_cost': 0,'start_price': 0, 'start': 0,
                                                                            'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                            'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                            'end_qty': 0, 'end_cost': 0, 'end_price': 0,'whs': {}}
                        if wh.id not in data_dict[f['group_id']]['lines'][f['prod']]['whs']:
                            data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id] = {'start_qty': 0, 'start_cost': 0,'last_cost': 0, 'start_price': 0, 'start': 0,
                                                                                          'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                                          'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                                          'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                        if f['q'] > 0:
                        ...
                        if f['prod'] not in data_dict:
                            data_dict[f['prod']] = {'start_qty': 0, 'start_cost': 0, 'start_cost_total': 0,'last_cost': 0, 'start_price': 0, 'start': 0,
                                                    'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                    'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                    'end_qty': 0, 'end_cost': 0, 'end_price': 0,'whs': {}}
                        if wh.id not in data_dict[f['prod']]['whs']:
                            data_dict[f['prod']]['whs'][wh.id] = {'start_qty': 0, 'start_cost': 0,'start_cost_total': 0,'last_cost': 0, 'start_price': 0, 'start': 0,
                                                                  'in_qty': 0, 'in_cost': 0, 'in_price': 0, 'in': 0,
                                                                  'out_qty': 0, 'out_cost': 0, 'out_price': 0, 'out': 0,
                                                                  'end_qty': 0, 'end_cost': 0, 'end_price': 0}
                        if f['q'] > 0:
            ...
            if not wids:
                raise osv.except_osv(_('Warning !'), _(u'Багадаа нэг агуулах чагтлаж өгнө үү!'))
            ...
            for wh in warehouses:
                ...
                if company.store_cost_per_warehouse:
                    ctx.update({'warehouse':wh.id})
                if wiz['cost']:
                    warehouse_cost_dict[wh.id] = product_obj.price_get(cr, uid, 
                            prod_ids, ptype='standard_price', context=ctx)
                prices[wh.id] = product_obj.price_get(cr, uid, prod_ids, 'list_price', context=ctx)
...
#                     row += ['<b>%s</b>'%total_dict['start_cost']]
                    row += ['<b>%s</b>'%total_dict['start_cost_total']]
                ...
                if wiz['cost']:
#                     row += ['<b>%s</b>'%(total_dict['start_cost_total']+total_dict['in_cost']-total_dict['out_cost'])] Засварлах
                    row += ['<b>%s</b>'%((total_dict['start_qty']+total_dict['in_qty']-total_dict['out_qty']) * total_dict['last_cost'])]
            ...
            for wh in warehouses:
                if wh.id in total_dict['whs']:
                    ...
                    row += ['<b>%s</b>'%total_dict['whs'][wh.id]['start_qty'],
                           '<b>%s</b>'%total_dict['whs'][wh.id]['start']]
                    if wiz['cost']:
                        if wh.id == 1:
                            row += ['<b>%s</b>'%total_dict['whs'][wh.id]['start_cost_total']]
                        else:
                    ...
                    #үнэ өөрчлөлт хэсэг comment болгрв
                    # if wh.id in change_dict['whs']:
                    #     row += ['<b>%s</b>'%change_dict['whs'][wh.id]['total']]
                    # else:
                    #     row += ['<b>0.0</b>']
                    #Нийт худалдах үнэ болон нийт дүн
                        ...
                        if wh.id == 1:
                            ...
                            for prod in sorted(prods.values(), key=itemgetter(wiz['sorting'])):
                                if prod['id'] in data_dict:
                                    ...
                                    if len(warehouses) > 1:
                                        last_cost_total += (line['start_qty']+line['in_qty']-line['out_qty']) * line['last_cost'] 
    #                                 for wh in warehouses:
                                    else:
                                        ent_qty = line['whs'][wh.id]['start_qty']+line['whs'][wh.id]['in_qty']-line['whs'][wh.id]['out_qty']
                                        last_cost_total += ent_qty * line['whs'][wh.id]['last_cost']
                            row += ['<b>%s</b>'%(last_cost_total)] 
                        else:
...
#                                     row += ['<b>%s</b>'%(val['start_cost'])]
                                    row += ['<b>%s</b>'%(val['start_cost_total'])]
...
#                                     row += ['<b>%s</b>'%(val['start_cost_total']+val['in_cost']-val['out_cost'])]
                                    row += ['<b>%s</b>'%((val['start_qty']+val['in_qty']-val['out_qty']) * val['last_cost'])]
                            else:
                                row += [val['start_qty'],val['start_price']]
                                if wiz['cost']:
#                                     row += [val['start_cost']]
                                    row += [val['start_cost_total']]
...
#                                     row += [(val['start_cost_total']+val['in_cost']-val['out_cost'])]
                                    row += [((val['start_qty']+val['in_qty']-val['out_qty']) * val['last_cost'])]
                        for wh in warehouses:
                            if wiz['type'] == 'detail':
                                row += ['']
                                if wh.id in val['whs']:
...
#                                         row += ['<b>%s</b>'%(val['whs'][wh.id]['start_cost'])]
                                        row += ['<b>%s</b>'%(val['whs'][wh.id]['start_cost_total'])]
...
#                                         row += ['<b>%s</b>'%(val['whs'][wh.id]['start_cost_total']+val['whs'][wh.id]['in_cost']-val['whs'][wh.id]['out_cost'])]
                                        row += ['<b>%s</b>'%((val['whs'][wh.id]['start_qty']+val['whs'][wh.id]['in_qty']-val['whs'][wh.id]['out_qty']) * val['whs'][wh.id]['last_cost'])]
                                else:
                                    row += ['<b>0.0</b>','<b>0.0</b>']
                                    if wiz['cost']:
                                        row += ['<b>0.0</b>']
...
#                                         row += [val['whs'][wh.id]['start_cost']]
                                        row += [val['whs'][wh.id]['start_cost_total']]
...
#                                         row += [(val['whs'][wh.id]['start_cost_total']+val['whs'][wh.id]['in_cost']-val['whs'][wh.id]['out_cost'])]
                                        row += [((val['whs'][wh.id]['start_qty']+val['whs'][wh.id]['in_qty']-val['whs'][wh.id]['out_qty']) * val['whs'][wh.id]['last_cost'])]
                                else:
                                    row += [0.0,0.0]
                                    if wiz['cost']:
                                        row += [0.0]
                        ...
                        if wiz['type'] == 'detail':
                            ...
                            if wiz['grouping'] == 'manufacture' and val['group_id']:
                                prods = product_obj.search(cr, uid, [('id','in',prod_ids),('manufacturer','=',val['group_id'])], context=context)
                            elif wiz['grouping'] == 'category':
                                prods = product_obj.search(cr, uid, [('id','in',prod_ids),('categ_id','=',val['group_id'])], context=context)
                            elif wiz['grouping'] == 'pos_categ':
                                prods = product_obj.search(cr, uid, [('id','in',prod_ids),('pos_categ_id','=',val['group_id'])], context=context)
                            prods = dict([(x['id'], x) for x in product_obj.read(cr, uid, prods, 
                                        ...
                                        if wiz['cost']:
                                            for wh in warehouses:
                                                if wh.id == 1:
                                                    ...
                                                    row += [((line['start_qty']+line['in_qty']-line['out_qty']) * line['last_cost'] )]
                                    for wh in warehouses:
                                        price = 0.0
...
#                                                 row += [line['whs'][wh.id]['start_cost']]
                                                row += [line['whs'][wh.id]['start_cost_total']]
...
#                                                 row += [(line['whs'][wh.id]['start_cost_total']+line['whs'][wh.id]['in_cost']-line['whs'][wh.id]['out_cost'])]
                                                row += [ent_qty * ine['whs'][wh.id]['last_cost'] ]
                                        else:
                                ...
                                data.append( row )
                                count += 1
                        number += 1 # Энэ нөхцлийг бүхэлд нь засварлах
                else:
                    prods = dict([(x['id'], x) for x in product_obj.read(cr, uid, prod_ids, 
                                        ['ean13','name','default_code','uom_id'], context=context)])
                    for prod in sorted(prods.values(), key=itemgetter(wiz['sorting'])):
...
#                                     row += [(int(2))]
                            for wh in warehouses:
                                ...
                                row += [price]
                                if wh.id in line['whs']:
                                    row += [line['whs'][wh.id]['start_qty'],line['whs'][wh.id]['start_qty']*price]
                                    # Өөрчлөлт [line['whs'][wh.id]['start_qty'],line['whs'][wh.id]['start_price']]
                                    if wiz['cost']:
                                        if wh.id == 1:
#                                         row += [line['whs'][wh.id]['start_cost']]
#                                         row += [line['whs'][wh.id]['start_cost_total']]
                                            row += [(line['whs'][wh.id]['start_cost'] * line['whs'][wh.id]['start_qty'])]
...
#                                         row += [(int(3))]
                                    ...
                                    if wiz['cost']:
                                        if wh.id == 1:
                                            row += [ent_qty * line['whs'][wh.id]['last_cost']]
                                        else:                                            
                                            row += [(line['whs'][wh.id]['start_cost']+line['whs'][wh.id]['in_cost']-line['whs'][wh.id]['out_cost'])]
#                                         row += [(int(4))]
                                else:
            ...
            initial_datetime_where = " and his.datetime <= '%s' " % (wiz['date_to'] + ' 23:59:59')
            total_dict = {'qty': 0,
                          'cost': 0,
                          'total_cost': 0,
                          'price': 0,
                    ...
                    if f['q'] <> 0:
                        if wiz['grouping']:
                            ...
                            if wiz['lot'] and wiz['type'] == 'detail':
                                ...
                                data_dict[f['group_id']]['lines'][f['prod']]['lots'][f['lot']]['total_cost'] += f['q'] * f['c']#f['tc']
                                ...
                                data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['lots'][f['lot']]['total_cost'] += f['q'] * f['c']#f['tc']
                            ...
                            data_dict[f['group_id']]['lines'][f['prod']]['total_cost'] += f['q'] * f['c']#f['tc']
                            ...
                            data_dict[f['group_id']]['lines'][f['prod']]['whs'][wh.id]['total_cost'] += f['q'] * f['c']#f['tc']
                            ...
                            if wiz['lot']:
                                ...
                                data_dict[f['prod']]['lots'][f['lot']]['total_cost'] += f['q'] * f['c']#f['tc']
...
#                     row +=['<b>%s</b>'%total_dict['cost']]
                    row +=['<b>%s</b>'%total_dict['total_cost']]
...
#                         row +=['','<b>%s</b>'%total_dict['whs'][wh.id]['cost']]
                        row +=['','<b>%s</b>'%total_dict['whs'][wh.id]['total_cost']]
                else:
                    row += ['','<b>0.0</b>','<b>0.0</b>']
                    if wiz['cost']:
                        row += ['','<b>0.0</b>']
...
#                                                 row[prowx] += ['<b>%s</b>'%line['cost']]
                                                row[prowx] += ['<b>%s</b>'%line['total_cost']]
                                                colx += 1
                                    for wh in warehouses:
                                        price = 0.0
                                        ...
                                        if wh.id in line['whs']:
                                            if wiz['lot']:
                                                ...
                                                for l in sorted(line['whs'][wh.id]['lots'].values(), key=itemgetter('name')):
                                                    ...
                                                    if l['qty'] > 0 and l['total_cost'] > 0:
#                                                         cost = round(float(l['cost'])/float(l['qty']),2)
                                                        cost = round(float(l['total_cost'])/float(l['qty']),2)
#                                                         cost = float(l['cost'])
                                                    if wiz['cost']:
#                                                         row[lrow] += [cost,l['cost']]
                                                        row[lrow] += [cost,l['total_cost']]
                                                    lrow += 1
...
#                                                     cost = round(float(line['whs'][wh.id]['cost'])/float(line['whs'][wh.id]['qty']),2)
                                                if line['whs'][wh.id]['qty'] > 0 and line['whs'][wh.id]['total_cost'] > 0:
                                                    cost = round(float(line['whs'][wh.id]['total_cost'])/float(line['whs'][wh.id]['qty']),2)
                                                row[prowx] += [price,line['whs'][wh.id]['qty'],line['whs'][wh.id]['price']]
                                                if wiz['cost']:
#                                                     row[prowx] += [cost,line['whs'][wh.id]['cost']]
                                                    row[prowx] += [cost,line['whs'][wh.id]['total_cost']]
                                        else:
                                            if len(line['lots']) > 1 and wiz['lot']:
                                                to_rowspan ((colx,rowx),(colx,rowx+len(line['lots'])-1)) 
                                                to_rowspan ((colx+1,rowx),(colx+1,rowx+len(line['lots'])-1)) 
...
#                                         row[rrowx] += ['<b>%s</b>'%line['cost']]
                                        row[rrowx] += ['<b>%s</b>'%line['total_cost']]
                                        colx += 1
                            for wh in warehouses:
                                price = 0.0
                                cost = prod['standard_price'] or 0.0
...
#                                                 row[lrow] += [cost,l['cost']]
                                        ...
                                        colx += 3
                                        if wiz['cost']:
                                            row[rrowx] += [cost,line['whs'][wh.id]['total_cost']]
                                            colx += 2
                                else:
                                    if len(line['lots']) > 1 and wiz['lot']:
                                        to_rowspan ((colx,rowx),(colx,rowx+len(line['lots'])-1)) 
