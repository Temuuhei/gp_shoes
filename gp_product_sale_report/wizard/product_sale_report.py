            ...
            for sd in so_data:
                ...
                if not sd['product_id'] in dq_p_ids:
                    ...
                    for dq1 in data_quant:
                        if dq1['tmpl'] == row[0]['tid']:
                            arr_index = data_quant.index(dq1)
